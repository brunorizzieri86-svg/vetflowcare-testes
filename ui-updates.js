...
function setupRegistrationSteps(sp){
 ...
 scene.innerHTML='<svg class="registration-background" viewBox="0 52 691 1401" preserveAspectRatio="xMidYMid meet" aria-hidden="true"><svg x="0" y="52" width="691" height="1401" viewBox="0 52 691 1401" overflow="hidden"><image href="access-art.jpg" width="691" height="1536"/></svg></svg>';
 sp.appendChild(scene);scene.appendChild(shell);
